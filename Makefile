...
help:
	...
	@echo "           with SHA-512 checksum at $(BUILD_DIR)/$(_build_name).sha512sum"
	...
	@echo "      $(BUILD_DIR)/$(_build_name).tar.gz with SHA-512 checksum at"
	@echo "      $(BUILD_DIR)/$(_build_name).sha512sum."
	@echo ""
